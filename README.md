...
The Causal Testing Framework is composed of a causal inference-driven architecture designed for functional black-box testing.
...
![Causal Testing Workflow](docs/source/_static/images/schematic-dark.png#gh-dark-mode-only)
![Causal Testing Workflow](docs/source/_static/images/schematic.png#gh-light-mode-only)
...
## Usage
>[!NOTE]
> Step-by-step tutorials can be found on our [documentation](https://causal-testing-framework.readthedocs.io/en/latest/tutorials.html).
